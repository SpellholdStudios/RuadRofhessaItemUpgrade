...
<div align="center"><h1></a>Ruad Item Upgrade Mod (WIP)</h1>
...
In addition to the methods above for removing individual components, you can completely uninstall the mod using **`setup-ruad --uninstall`** at the command line to remove all components without wading through prompts.</br>
<div align="right"><a href="#top">Back to top</a></div>
...
#### Author: <a href="moonfruit@ananzi.co.za">Moonfruit</a>
...
- Items updates:
	...
	- <ins>Shield of Many Dragons (u#shld01.itm):
		- Fixed item description: added missing kit restrictions.
